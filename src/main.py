...
def main():
    ...
    parser.add_argument("--pipeline", type=parse_pipeline, default=f'{ChatGPTModel.GPT_5_NANO.value}, 0; {ChatGPTModel.GPT_5_MINI.value}, 120; {ChatGPTModel.GPT_5.value}, 300', help="Pipeline of LLM models with their timeouts in seconds, formatted as: model, timeout; model, timeout;... Example: gpt-4,120;deepseek,300")
